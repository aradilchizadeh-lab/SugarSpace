    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        if (n==0){
            ...
            int l = s.length();
            double x0 = 0.5 , y0 = 0.5 , x = x0+2.0/(l+1.0) , y = y0,x1 = 0,y1 = 0 ;
            //System.out.println(s);
            System.out.println(s);
            ...
            for (int j = 0 ; j<l ; j++){
                ...
                if (a==F){
                    ...
                    if(signxy>0){
                        y = y0 + signL*(2.0/(l+1.0));
                        
                    }
                    else{
                        x = x0 + signL*(2.0/(l+1.0));
                    }
                    signL = -signL;
                    signxy = -signxy;
                    x0 = x1;
                   ...
                   if(signxy>0){
                    y = y0 + signR*(2.0/(l+1.0));
                   }
                   else{
                    x = x0 + signR*(2.0/(l+1.0));
                   }
                   signR = -signR;
                   signxy = -signxy;
                   x0 = x1;
       ...
       /*StdDraw.setPenColor(StdDraw.BOOK_RED);
        ...
        StdDraw.line(0.0, 0.04, 0.05, 0.04);
        */
