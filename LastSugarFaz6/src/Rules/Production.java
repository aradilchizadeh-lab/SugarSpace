            ...
            if (agents.get(k) instanceof IAgent_Prodution agent) {
                ...
                while (!selectedPatches.isEmpty()) {
                    ...
                    if (randomPatch.getPAgent() == null && !emptyPatchFlag) {
                        ...
                        if(randomPatch.getPAgent() instanceof IAgent_Prodution neighbor) {
                            //IAgent_Prodution neighbor = (IAgent_Prodution) randomPatch.getPAgent();

                            //---[checking random patch if it agent can be parent]---
